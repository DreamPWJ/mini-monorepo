<template>
  <div class="qrpay flex flex-column">
    ...
    <div class="card flex flex-column">
      <div v-for="(item, index) in infos" :key="index" style="margin: 0 10px;">
        <div class="flex flex-row item">
          ...
          <IconFont :name="item.icon" v-if="item.icon" style="margin-right: 10px;color:#9496A5" @click="tipsClick(item)">
          </IconFont>
